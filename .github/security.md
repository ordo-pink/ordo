...
Thank you for taking the time to investigate the security of ORDO. The security of ORDO is our topmost priority.
We appreciate investigative work into system security by well-intentioned, ethical security researchers.
If you discover a vulnerability, however small, we would like to know about it to address it with appropriate
measures as quickly as possible. This document outlines the method we use to work with the security research
community to address runtime security.
...
Please open a new
[Security advisory](https://github.com/ordo-pink/ordo/security/advisories/new)
...
- Do provide sufficient information to reproduce the problem, so we will be able
  ...
  the vulnerable ORDO version is enough. More complex vulnerabilities may

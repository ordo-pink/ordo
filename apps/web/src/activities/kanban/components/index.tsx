  ...
  return Either.fromNullable(state).fold(Null, (dir) => (
    <Workspace sidebarChildren={null}>
      <DragDropContext onDragEnd={onDragEnd}>
        ...
        >
          {(provided) => (
            <div className="flex flex-col space-y-4 m-4 mt-10 h-full rounded-lg bg-gradient-to-b from-slate-400 to-stone-400 dark:from-zinc-900 dark:to-stone-900 shadow-lg p-4">
              <div

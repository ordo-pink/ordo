...
const matcher: LinkMatcher = (x) => {
  const matched = x.match(linkRx)
...
const AutoLinkPlugin = () => {
  return <LexicalAutoLinkPlugin matchers={[matcher]} />
}

export default createEditorPluginExtension("autolink", {
  editorPlugins: [AutoLinkPlugin],
})

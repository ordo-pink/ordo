...
export const modal = maoka.create("div", ({ use }) => {
	...
	const handle_click = () => hunter.shoot("@ordo/main.modal.hide")
	const handle_show: OrdoClient.Command.GunFor<"@ordo/main.modal.show"> = params => $.update("instance", () => params)
	const handle_hide: OrdoClient.Command.GunFor<"@ordo/main.modal.hide"> = () => $.update("instance", () => void 0)
	const handle_mount = () =>
	...
	use(ordo_client_maoka.jabs.handle_command("@ordo/main.modal.hide", handle_hide))
	use(ordo_client_maoka.jabs.handle_command("@ordo/main.modal.show", handle_show))
...
const close_modal = maoka.create("div", ({ use }) => {
	...
	const handle_click = () => void hunter.shoot("@ordo/main.modal.hide")

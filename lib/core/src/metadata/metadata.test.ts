...
const test1 = Metadata.Of({ name: "test", parent: null, author_id: "test-test-test-test-test" })

const test2 = Metadata.Of({
	name: "test",
	parent: null,
...
const test3 = Metadata.FromDTO(dto)

describe("Metadata", () => {
	describe("`Metadata.from` required properties", () => {
		it("get_name should return DTO name", () => {
			expect(test1.get_name()).toEqual("test")
		})

		it("get_parent should return DTO parent", () => {
			expect(test1.get_parent()).toEqual(null)
		})

		it("get_created_by should return DTO createdBy", () => {
			expect(test1.get_created_by()).toEqual("test-test-test-test-test")
		})

		it("get_updated_by should return DTO createdBy", () => {

...
export const items = maoka_styled.tags.div("command-palette_items")

export const nothing_found_div = maoka_styled.tags.div("command-palette_items_nothing-found")

...
export const notification_icon = create.create<Pick<ClientSDK.Notification.Instance, "render_icon" | "type">>(
	"div",
	({ render_icon, type, use }) => {
		if (render_icon) use(create.dom.jabs.hit_if_dom(n => void render_icon(n.value as HTMLDivElement)))

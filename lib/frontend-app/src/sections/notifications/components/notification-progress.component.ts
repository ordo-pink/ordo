...
export const notification_progress = create_component.create<Args>("div", ({ id, type, duration, use }) => {
...
const progress_bar_foreground = create_component.create<P>("div", ({ progress, type, use }) => {
	if (!progress) return

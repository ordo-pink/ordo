...
const create_notification_card = (card_type: string) => maoka_styled.tags.div(`notification-card ${card_type}`)
const notification_body = maoka_styled.tags.div("notification-card_body")
const notification_message = maoka_styled.tags.p()
const notification_title = maoka_styled.tags.h2("notification-card_title")

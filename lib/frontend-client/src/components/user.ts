...
import { CurrentUserRepository, CurrentUserRepositoryAsync, PublicUserRepository, RRR, UserQuery } from "@ordo-pink/core"
...
type TInitUserParams = (params: Pick<TInitCtx, "hosts" | "fetch" | "logger" | "commands" | "known_functions">) => {
...
export const init_user: TInitUserParams = call_once(({ hosts, fetch, logger, commands, known_functions }) => {
	...
	CurrentUserManager.of(current_user_repository, current_user_remote_repository, auth$).start(state_change =>

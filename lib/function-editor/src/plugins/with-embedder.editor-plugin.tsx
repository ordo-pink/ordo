...
export const withInternalEmbedder = <T extends ReactEditor>(editor: T): T => {
	const { deleteBackward } = editor

	editor.isVoid = element => {
		return (element as any).type === "file-embed" ? true : editor.isVoid(element)
	}

	editor.markableVoid = element => {
		return (element as any).type === "file-embed" || editor.markableVoid(element)
	}

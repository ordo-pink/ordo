...
export type TCurrentUserManagerStatic = {
	of: (
		memory_repository: Ordo.User.Current.Repository,
		remote_repository: Ordo.User.Current.RepositoryAsync,
		auth$: Observable<TOption<AuthResponse>>,
	) => TUserManager
}

export type TUserManagerStateChange = "get-remote" | "get-remote-complete" | "put-remote" | "put-remote-complete"

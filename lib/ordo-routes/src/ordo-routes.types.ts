...
export type OrdoRouteDefinitionContext<T extends Record<string, unknown> = Record<string, unknown>> = T & { host: string }
...
export type OrdoRouteMap<Keys extends string, T extends Record<string, unknown> = Record<string, unknown>> = Record<
	Keys,

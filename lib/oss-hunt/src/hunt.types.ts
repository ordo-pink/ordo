 ...
 */
export type Shot<$Preys extends BasePreys, $Prey extends keyof $Preys = keyof $Preys, $Bullet = any> = {
	bullet: $Bullet
	prey: $Prey
 ...
 * const deer_gun: GunFor<Prey, "deer"> = name => console.log(name)
 * hunter.track("deer", deer_gun)
 * ```
 */
export type GunFor<$Preys extends BasePreys, $Prey extends keyof $Preys> = Gun<$Preys[$Prey]>
 ...
 * ```
 */
export type Shoot<$Preys extends BasePreys> = <$Prey extends keyof $Preys>(
	/**
	 * Prey to shoot.
	 */
	prey: $Prey,
 ...
 * ```
 */
export type Track<$Preys extends BasePreys> = <$Prey extends keyof $Preys>(
	/**
	 * Prey to track.
	 */
	prey: $Prey,
 ...
 * Internal hunt state.
 */
export type State<$Preys extends BasePreys> = {
	barrage: Shot<$Preys>[]
	gun_storage: Record<string, Gun<any>[]>
}
...
export type Instance<$Preys extends Record<string, unknown>> = {
	/** @see {@link Track} */
	track: Track<ToPreys<$Preys>>
	/** @see {@link Shoot} */
	shoot: Shoot<ToPreys<$Preys>>
}
 ...
 */
export type ToPreys<$Preys extends Record<string, unknown>> = KeyValueToRecord<ToFlatRecord<$Preys>>

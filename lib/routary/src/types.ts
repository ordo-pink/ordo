...
export type Gear<RouterState extends RequiredRouterState = RequiredRouterState> = (ctx: Context<RouterState>) => Oath<any, any>

export type CheckMethodFn = (method: HttpMethod, req: Request) => boolean

export type CheckRouteFn = (route: Route, req: Request) => boolean

export type Context<RouterState extends RequiredRouterState = RequiredRouterState, ResponseBody = any> = {
	route: Route
	req: Request
...
export type RouteMap<T extends RequiredRouterState = RequiredRouterState> = [HttpMethod, Route, Gear<T>][]

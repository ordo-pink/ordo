...
export type Start = <$Env extends Lib.PrefilledEnv, $Mut extends Routary.Mut>(params: Params<$Env, $Mut>) => Mut

export type End = <$Env extends Lib.PrefilledEnv, $Mut extends Mut>(

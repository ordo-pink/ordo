import type { OrdoFile, OrdoDirectory, OrdoPath, OrdoRelativePath } from "@core/app/types"
...
export const createOrdoDirectory = (props: Props): OrdoDirectory => {
  ...
  return {
    ...props,
    readableName,
    children: [] as Array<OrdoFile | OrdoDirectory>,
    metadata: {
      color: Color.NEUTRAL,
    },
  }

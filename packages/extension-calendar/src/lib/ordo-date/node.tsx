...
export class OrdoDateNode extends DecoratorNode<ReactNode> {
  ...
  static override clone(node: OrdoDateNode): OrdoDateNode {
    return new OrdoDateNode(node.__startDate, node.__endDate, node.__key)
  }

  static override importJSON(serializedNode: SerializedOrdoDateNode): OrdoDateNode {
  ...
  override exportJSON(): SerializedOrdoDateNode {
    return {
      detail: 0,
      format: 0,
      mode: "token",

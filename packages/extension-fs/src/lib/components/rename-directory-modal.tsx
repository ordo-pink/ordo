...
export default function RenameDirectoryModal({ directory }: Props) {
  ...
  const [directoryName, setDirectoryName] = useState(directory.readableName)
  const [isValidPath, setIsValidPath] = useState(true)
  const [parentPath, setParentPath] = useState(OrdoDirectory.getParentPath(directory.path))
  ...
  const tTitle = t("rename-directory")

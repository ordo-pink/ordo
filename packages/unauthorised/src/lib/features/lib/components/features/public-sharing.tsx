...
export default function PublicSharingFeature() {
  const { t } = useTranslation()

  const translatedTitle = t("@ordo-activity-features/public-sharing-title")
  const translatedText = t("@ordo-activity-features/public-sharing-text")

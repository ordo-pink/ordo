  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <section className="flex flex-col items-center text-center space-y-4 p-4 md:flex-row flex-nowrap md:space-y-0 md:space-x-24 md:justify-between md:pt-32">
          <div>
            <h1 className="text-5xl font-black max-w-xl">
              Помогаем беречь и множить знания
            </h1>
          ...
          <div className="flex flex-col space-y-2">
            <Link
              to="/download"
              className="px-8 py-2 bg-gradient-to-tr from-pink-500 to-cyan-500 rounded-xl font-semibold text-xl text-white whitespace-nowrap"
            >
              Скачать бесплатно*
            </Link>
      ...
      <section className="flex flex-col items-center py-16 mx-auto max-w-5xl justify-center p-4 text-center">
        ...
        <div className="flex flex-col space-y-8 mb-8 lg:flex-row lg:items-center lg:space-x-4 lg:text-left">
          <div>
            ...
            <p className="max-w-[500px] mx-auto">
              ...
              креативность - это не открытие нового, а связывание существующего.
              Мы сделали так, чтобы создание связей было простым и удобным. А
              Graph View поможет вам посмотреть на свои знания с высоты птичьего
              полёта.
            </p>
          </div>
          <StaticImage
        ...
        <div className="flex flex-col space-y-8 mb-8 lg:flex-row lg:items-center lg:space-x-4 lg:text-left">
          <div>
            ...
            <p className="max-w-[500px] mx-auto">
              ...
              формулировки у нас здесь, да. Проходите, присаживайтесь. С нами не
              соскучишься. Зато с канбан-доской удобно формулировать и
        ...
        <Link
          to="/download"
          className="px-8 py-2 bg-gradient-to-tr from-pink-500 to-cyan-500 rounded-xl font-semibold text-xl text-white"
        >
          Уговорили, скачать
        </Link>
      </section>

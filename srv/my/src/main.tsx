...
import { WhoEntryLogger } from "@ordo-pink/frontend-whoentry"
...
const myHost = import.meta.env.VITE_ORDO_MY_HOST
const weHost = import.meta.env.VITE_ORDO_WE_HOST
const env = import.meta.env.MODE

const logger = WhoEntryLogger.create({ clientLogger: ConsoleLogger, host: weHost, env })
